{7б. Ќаписать программу, котора€ иллюстрирует работу шейкерной сортировки.
ѕровести сравнение сортировок методом "пузырька" и шейкерной по количеству сравнений,
по количеству обменов. ƒл€ этого построить графики зависимостей данных величин
...
begin
  ...
  step:= MaxN div count;
  N:= step;
  Chart.Series[0].Clear; //сравнени€
  Chart.Series[1].Clear; //перемещени€
...
//вывести сгенерированный массив на listbox дл€ сортировки
...
begin
  ...
  ShakerSort(mas,lstSort);

  ShowMessage('ќтсортировано');
